import 'package:clothes_app/common/widgets/texts/brand_title_text.dart';
...
class BrandTitleTextWithVerifyIcon extends StatelessWidget {
  final String title;
  final int maxLines;
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        const Icon(Iconsax.verify5, color: GColors.primary, size: GSize.iconXs),
      ],
    );
  }
}
